...
public class CouponDAO {
    ...
    public static boolean doSave(Coupon coupon) throws SQLException {
        ...
        try(Connection con = ConPool.getConnection()){
            ...
            QueryBuilder qb = new QueryBuilder("coupon", "c").insert("numeroCoupon", "stato", "sconto",
            "cfCreatore");
    ...
    public static boolean doUpdate(Coupon coupon) throws SQLException{
        ...
        try(Connection con = ConPool.getConnection()){
            ...
            try(PreparedStatement ps = con.prepareStatement(qb.select().where("c.numeroCoupon = " +
                    coupon.getNumeroCoupon()).getQuery()))
            {
                ...
                try(PreparedStatement pss = con.prepareStatement(qb.update("numeroCoupon", "stato", "sconto", "cfCreatore").getQuery())){//TODO where
                    ...
                    pss.setFloat(3, coupon.getSconto());
                    pss.setString(4, coupon.getCreatore().getCF());
